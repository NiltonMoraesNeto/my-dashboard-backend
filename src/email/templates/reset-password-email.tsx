        ...
        <Body className="bg-gray-50 my-auto mx-auto font-sans">
          <Container className="border border-gray-200 rounded-lg my-10 mx-auto p-5 w-[600px] bg-white">
            ...
            <Section className="mt-8">
              ...
              <Text className="text-base text-gray-700 mb-4">
                Você solicitou a recuperação de senha. Use o código abaixo para
                redefinir sua senha:
              </Text>
              ...
              <Text className="text-sm text-gray-600 mb-4">
                Se você não solicitou esta recuperação de senha, ignore este
                email.
              </Text>
            </Section>
            ...
            <Section className="text-center">
              ...
              <Text className="text-xs text-gray-500 mt-2">
                © {new Date().getFullYear()} Sistema de Gestão Inteligente para
                Condomínios. Todos os direitos reservados.{' '}
                <a href="https://www.lab808.com.br/">Lab808</a>
              </Text>
            </Section>
          </Container>
        </Body>
